...
const CarouselCard2 = () => {
    ...
    return (
        <div className='grid grid-cols-2 place-items-center relative w-full px-16'>
            ...
            : "flex flex-col items-start gap-4 pt-20 -translate-x-[70rem] transition-all ease-out duration-[800ms]"}>
            ...
            <div className="flex flex-col">
                ...
                : "absolute -top-2 -right-[70rem] w-[47rem] transition-all ease-out duration-[800ms]"}>
