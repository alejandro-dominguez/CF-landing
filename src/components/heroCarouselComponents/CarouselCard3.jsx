    ...
    return (
        <div className='grid grid-cols-2 place-items-center relative w-full px-16'>
            ...
            <div className="flex flex-col">
                <div className={activeClass ? "absolute -top-8 -right-12 w-[47rem] transition-all ease-out duration-[800ms]"
                : "absolute -top-8 -right-[40rem] w-[47rem] transition-all ease-out duration-[800ms]"}>
