...
const CarouselCard1 = () => {
    ...
    return (
        <div className='grid grid-cols-2 place-items-center relative w-full px-16'>
            ...
            : "flex flex-col items-start gap-4 pt-20 -translate-x-[40rem] transition-all ease-out duration-[800ms]"}>
            ...
            <div className="flex flex-col">
                <div className={activeClass ? "absolute top-2 -right-12 w-[45rem] transition-all ease-out duration-[800ms]"
                : "absolute top-2 -right-[40rem] w-[45rem] transition-all ease-out duration-[800ms]"}>
