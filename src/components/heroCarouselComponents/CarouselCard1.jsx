...
const CarouselCard1 = ({ setTabIndex }) => {
    ...
    return (
        <div className='grid grid-cols-2 place-items-center relative w-screen px-16'>
            ...
            <div className="flex flex-col">
                <div className={activeClass ? `absolute -top-2 -right-12 w-[45rem] transition-all ease-out opacity-100
                duration-[800ms] overflow-x-hidden`
                : `absolute -top-2 -right-12 translate-x-[500px] w-[45rem] transition-all ease-out duration-[800ms]
